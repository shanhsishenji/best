...
const cn = {
  ...
  Store: {
    DefaultTopic: "新的聊天",
    BotHello: "领航员，欢迎回来！本项目属于公益免费项目，不定期开放GPT4等新模型。您可以与我进行对话，我将帮助你解答一些问题。在对话时请遵守您的所在国家/地区法律法规，请不要使用带有包括但不限于侮辱、政治、色情、暴力等词语！我们之间的对话记录保留在您的浏览器上！如果您不同意此条款，请不要使用本项目进行对话！如出现无法对话请在群内联系管理处理（左下企鹅图标）",
    Error: "出错了，稍后重试吧",
    Prompt: {
